...
<head>
    ...
    <link rel="stylesheet" href={{asset("Private/Messenger/all.css")}} integrity="sha384-B4dIYHKNBt8Bc12p+WXckhzcICo0wtJAoU8YZTY5qE0Id1GSseTk6S+L3BlXeVIU" crossorigin="anonymous">
    <script src={{asset("Private/Messenger/jquery.min.js")}}></script>
    <link rel="stylesheet" type="text/css" href={{asset("Private/Messenger/jquery.mCustomScrollbar.min.css")}}>
    <script type="text/javascript" src={{asset("Private/Messenger/jquery.mCustomScrollbar.min.js")}}></script>
</head>
<body class="g-sidenav-show  bg-gray-200">
<style>
    .bbody{
        background: linear-gradient(to right, #71EAE4, #66A8E7, #5F7FD5);
        height: 70px;
        color: black;
    }
    .pbody{
        color: black;
        height: 110px;
        background: linear-gradient(to right, #21EAE4, #16A8E7, #0F7FD5);
    }
    .chat{
        margin-top: auto;
        margin-bottom: auto;
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
                ...
                <a class="nav-link text-white " href="send">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" fill="currentColor" class="bi bi-cart4" viewBox="0 2 16 16">
            ...
            <li class="nav-item">
                <a class="nav-link text-white active bg-gradient-primary" href="messenger">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">
...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
        <div class="row mt-4">
            ...
            <div class="col-lg-4 col-md-6 mt-4 mb-4 w-35" >
                <div class="card mb-sm-3 mb-md-0 contacts_card bbody">
                    <div class="card-header bbody">
                        <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                            <div class="input-group input-group-outline">
                        ...
                        <!--                  <input type="text" style="text-align: -moz-center; height: 40px ;width: 285px; border: 0.5px solid red" placeholder="Search..." class="form-control" />-->
                        <!--                </div>-->
                        <!--                <button type="button" class="btn btn-primary">-->
                        <!--                  <i class="fas fa-search"></i>-->
                        <!--                </button>-->
                        ...
                        <ui class="contacts">
                            <li class="active">
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="https://i.pinimg.com/736x/c3/36/1a/c3361a68ff4ca412b67e02c2ca04fa58.jpg" class="rounded-circle user_img">
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                                        <span>Farruhbek</span>
                                        <p>Farruhbek is online</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="https://hdwallpaperim.com/wp-content/uploads/2017/08/25/462707-universe-galaxy-space-stars-748x748.jpg" class="rounded-circle user_img">
                                        <span class="online_icon"></span>
                                    </div>
                                    <div class="user_info">
                                        <span>Sulaymon</span>
                                        <p>Sulaymon is online</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="https://t3.ftcdn.net/jpg/04/44/45/26/360_F_444452631_Nfi8r2QvxRKuupXSk1XR4u3h0PHNoXis.jpg" class="rounded-circle user_img">
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                                        <span>Aziz</span>
                                        <p>Aziz left 30 mins ago</p>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="d-flex bd-highlight">
                                    <div class="img_cont">
                                        <img src="https://play-lh.googleusercontent.com/EtpZydGFF-vDXDhlHIqEBIyocZcc2yPQpdcvZ2EjWFYdx37PyboreMABLEMDb5nEWg" class="rounded-circle user_img">
                                        <span class="online_icon offline"></span>
                                    </div>
                                    <div class="user_info">
                                        <span>Mirzohid</span>
                                        <p>Mirzohid left 50 mins ago</p>
                                    </div>
                                </div>
                            </li>
                        </ui>
            ...
            <div class="col-lg-8 mt-4 mb-4 w-65">

                <div class="card bbody w-100">
                    <div class="card-header msg_head pbody">
                        <div class="d-flex bd-highlight">
                            <div class="img_cont">
                                <img src="https://i.pinimg.com/736x/c3/36/1a/c3361a68ff4ca412b67e02c2ca04fa58.jpg" class="rounded-circle user_img">
                                <span class="online_icon"></span>
                    ...
                    <div class="card-body msg_card_body">
                        <div class="d-flex justify-content-start mb-4">
                            <div class="img_cont_msg">
                                <img src="https://i.pinimg.com/736x/c3/36/1a/c3361a68ff4ca412b67e02c2ca04fa58.jpg" class="rounded-circle user_img_msg">
                            </div>
                        ...
                        <div class="d-flex justify-content-end mb-4">
                            <div class="msg_cotainer_send">
                                Yaxshi Rahmat uzingna
                                <span class="msg_time_send">8:55</span>
                            </div>
                            <div class="img_cont_msg">
                                <img src="https://img.freepik.com/free-vector/romantic-love-message-hearts-background_1017-29964.jpg?w=2000" class="rounded-circle user_img_msg">
                            </div>
                        </div>
                        <div class="d-flex justify-content-start mb-4">
                            <div class="img_cont_msg">
                    ...
                    <div class="card-footer">
                        <div class="input-group">
                            <div class="input-group input-group-outline">
                                <span onclick="chatfile()" style="width: 35px; font-size: 23px; text-align: center"  class="attach_btn"><i class="fas fa-paperclip"></i></span>
                                <input id="chatfile" type="file" style="display: none">
                                <textarea name="" class="form-control type_msg" style="" placeholder="Type your message..."></textarea>
                                <span style="width: 40px; font-size: 23px; text-align: center"  class="send_btn"><i class="fas fa-location-arrow"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
