                    ...
                    <div class="col-xl-6 mb-xl-0 mb-4">
                        <div class="card bg-transparent shadow-xl">
                            <div class="overflow-hidden position-relative border-radius-xl">
                                <img src={{asset("Private/assets/img/illustrations/pattern-tree.svg")}} class="position-absolute opacity-2 start-0 top-0 w-100 z-index-1 h-100" alt="pattern-tree">
                                    ...
                                    <div class="d-flex">
                                        <div class="d-flex">
                                            <div class="me-4">
                                                ...
                                                <h6 class="text-white mb-0">Satimbayev Farruhbek</h6>
                                            </div>
                                            <div>
                                        ...
                                        <div class="ms-auto w-20 d-flex align-items-end justify-content-end">
                                            <img class="w-60 mt-2" src={{asset("Private/assets/img/logos/mastercard.png")}} alt="logo">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-6">
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0 p-3 text-center">
                                        <h6 class="text-center mb-0">kirgan Daromad</h6>
                                        <span class="text-xs">shu oy</span>
                                        <hr class="horizontal dark my-3">
                                        <h5 class="mb-0">+225000 so`m</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-6">
                                <div class="card">
                                    ...
                                    <div class="card-body pt-0 p-3 text-center">
                                        <h6 class="text-center mb-0">Ishlatildi</h6>
                                        <span class="text-xs">shu oy</span>
                                        <hr class="horizontal dark my-3">
                                        <h5 class="mb-0">-115000 so`m</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="list-group">
                            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                <div class="d-flex flex-column">
                                    <h6 class="mb-1 text-dark font-weight-bold text-sm">Noyabr</h6>
                            ...
                            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                <div class="d-flex flex-column">
                                    <h6 class="text-dark mb-1 font-weight-bold text-sm">Oktyabr</h6>
                            ...
                            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                <div class="d-flex flex-column">
                                    <h6 class="text-dark mb-1 font-weight-bold text-sm">Sentabr</h6>
            ...
            <div class="col-md-7 mt-4">
                <div class="card">
                    <div class="card-header pb-0 px-3">
                        <h6 class="mb-0">O`tkazmalar</h6>
                    </div>
                    <div class="card-body pt-4 p-3">
                        <ul class="list-group">
                            <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                <div class="d-flex flex-column">
                                    <h6 class="mb-3 text-sm">Azizbek</h6>
                                    <span class="mb-2 text-xs">User: <span class="text-dark ms-sm-2 font-weight-bold">azizbek@sf.com</span></span>
                                    <span class="text-xs">Card Number: <span class="text-dark ms-sm-2 font-weight-bold">**********5476</span></span>
                                </div>
                            ...
                            <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                <div class="d-flex flex-column">
                                    <h6 class="mb-3 text-sm">Suhrob</h6>
                                    <span class="mb-2 text-xs">User: <span class="text-dark ms-sm-2 font-weight-bold">ruzmetov@sf.com</span></span>
                                    <span class="text-xs">Card Number: <span class="text-dark ms-sm-2 font-weight-bold">**********7784</span></span>
                                </div>
                                <div class="ms-auto text-end">
                                    <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="javascript:;"><i class="material-icons text-sm me-2">delete</i>Delete</a>
                                </div>
                            ...
                            <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                                <div class="d-flex flex-column">
                                    <h6 class="mb-3 text-sm">Xushnudbek</h6>
                                    <span class="mb-2 text-xs">User: <span class="text-dark ms-sm-2 font-weight-bold">x.sultanov@sf.com</span></span>
                                    <span class="text-xs">Card Number: <span class="text-dark ms-sm-2 font-weight-bold">**********4603</span></span>
                                </div>
                                <div class="ms-auto text-end">
                                    <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="javascript:;"><i class="material-icons text-sm me-2">delete</i>Delete</a>
                                </div>
                    ...
                    <div class="card-header pb-0 px-3">
                        <div class="row">
                            ...
                            <div class="col-md-6 d-flex justify-content-start justify-content-md-end align-items-center">
                                ...
                                <small>Davrni tanlang</small>
                            </div>
                        </div>
                    </div>
                    <div class="card-body pt-4 p-3">
                        <ul class="list-group">
                            <h6 class="text-uppercase text-body text-xs font-weight-bolder my-3">Bugun</h6>
                            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <h6 class="mb-1 text-dark text-sm">Suhrob</h6>
                                        <span class="text-xs">12:31</span>
                                    </div>
                                </div>
                            ...
                            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <h6 class="mb-1 text-dark text-sm">Murodbek</h6>
                                        <span class="text-xs">16:43</span>
                                    </div>
                                </div>
                        ...
                        <h6 class="text-uppercase text-body text-xs font-weight-bolder my-3">Kecha</h6>
                        <ul class="list-group">
                            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                <div class="d-flex align-items-center">
                                    <button class="btn btn-icon-only btn-rounded btn-outline-success mb-0 me-3 p-3 btn-sm d-flex align-items-center justify-content-center"><i class="material-icons text-lg">expand_less</i></button>
                                    <div class="d-flex flex-column">
                                        <h6 class="mb-1 text-dark text-sm">Norbek</h6>
                                        <span class="text-xs">18:43</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center text-success text-gradient text-sm font-weight-bold">
                                    +15 000 so`m
                            ...
                            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                <div class="d-flex align-items-center">
                                    <button class="btn btn-icon-only btn-rounded btn-outline-success mb-0 me-3 p-3 btn-sm d-flex align-items-center justify-content-center"><i class="material-icons text-lg">expand_less</i></button>
                                    <div class="d-flex flex-column">
                                        <h6 class="mb-1 text-dark text-sm">Beco</h6>
                                        <span class="text-xs">21:57</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center text-success text-gradient text-sm font-weight-bold">
                                    +23 000 so`m
                            ...
                            <li class="list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg">
                                <div class="d-flex align-items-center">
                                    <button class="btn btn-icon-only btn-rounded btn-outline-success mb-0 me-3 p-3 btn-sm d-flex align-items-center justify-content-center"><i class="material-icons text-lg">expand_less</i></button>
                                    <div class="d-flex flex-column">
                                        <h6 class="mb-1 text-dark text-sm">Jony</h6>
                                        <span class="text-xs">15:45</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center text-success text-gradient text-sm font-weight-bold">
                                    +12 500 so`m
